...
Feedback from anyone using/testing the script is welcome! This v3 version likely works fine but it does have a v4 removal part that 
not been tested, if you pass in that option.
